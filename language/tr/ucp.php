...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'				=> 'Hesabınız oluşturuldu. Fakat, bu mesaj panosu hesap aktivasyonu istemektedir, belirlediğiniz e-posta adresine bir aktivasyon şifresi gönderildi. Lütfen daha fazla bilgi için e-posta adresinizi kontrol edin. Ayrıca e-posta kutunuzdaki önemsiz, spam ya da gereksiz postaların bulunduğu bölümleri de kontrol ettiğinize de emin olun. E-posta’nın size ulaşması e-posta sağlayıcınıza bağlı olarak zaman alabilir.',
	...
	'ATTACHMENT_LOCKED'				=> 'Bu konu kilitlendi, dosya ekini silemezsiniz.',	
	...
	'MESSAGE_REPORTED_MESSAGE'		=> 'Bildirilen mesaj',	
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'Özel mesajları yazdırmak için yetkiniz yok.',	
	...
	'EMAIL_NOT_UNIQUE'			=> 'Belirttiğiniz e-posta birden fazla kullanıcı tarafından kullanılıyor. Ayrıca kullanıcı adı da belirtmelisiniz.',	
	...
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'Eğer bir hesabınız mevcutsa, kayıtlı e-posta adresinize yeni bir şifre gönderilmiştir. Eğer bir e-posta almadıysanız, yasaklanmış olabilirsiniz, hesabınız aktif olmayabilir, veya şifrenizi değiştirmek için izniniz olmayabilir. E-posta alamamanızın bu sebeplerden herhangi birisi ile alakalı olup olmadığını öğrenmek için yönetici ile iletişime geçin. Ayrıca, spam filtrenizi kontrol edin.',
