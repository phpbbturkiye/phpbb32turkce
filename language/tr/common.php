...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ALREADY_LINKED'				=> 'Bu harici servis daha önce zaten başka bir mesaj panosu hesabıyla ilişkilendirilmiş.',
	...
	'AVATAR_PHP_UPLOAD_STOPPED'		=> 'Bir PHP eklentisi dosya yüklemeyi durdurdu.',	
	...
	'FEATURE_NOT_AVAILABLE' => 'İstenilen özellik bu mesaj panosunda mevcut değil.',	
	'FILENAME'				=> 'Dosya adı',
	...
	'NOTIFICATION_METHOD_INVALID'		=> '"%s" metotu geçerli bir bildirim metotu ile alakalı değil.',	
	...
	'NO_STYLE_DATA'				=> 'user_style %s için stil verisi alınamadı ve user_id %s için ayarlanmadı',
	'NO_STYLE_CFG'				=> 'Şunun için stil yapılandırma dosyası alınamadı: %s',	
	...
	'POST_DELETED_BY'		=> '<strong>%2$s</strong>, <strong>%1$s</strong> tarafından gönderilen mesajı %3$s tarihinde sildi.',
	'POST_DELETED_BY_REASON'=> '<strong>%2$s</strong>, <strong>%1$s</strong> tarafından gönderilen mesajı %3$s tarihinde sildi. Sebep: %4$s',
	...
	'SORRY_AUTH_READ_TOPIC'		=> 'Bu başlığı okuma yetkiniz yok.',	
