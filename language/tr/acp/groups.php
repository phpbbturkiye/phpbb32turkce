...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Bu ayar her kullanıcının klasör mesaj sınırının yerini alır. Kullanıcının tüm gruplar için kullanacağı en yüksek güncel değeri belirlemek için kullanılır.<br />Bu grubun tüm kullanıcıları için mevcut ayarı mesaj panosu genelindeki ayarla değiştirmek için değeri 0 olarak ayarlayın.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'Bir özel mesajda izin verilen en fazla alıcı sayısı. Kullanıcının tüm gruplar için kullanacağı en yüksek güncel değeri belirlemek için kullanılır.<br />Bu grubun tüm kullanıcıları için mevcut ayarı mesaj panosu genelindeki ayarla değiştirmek için değeri 0 olarak ayarlayın.',
