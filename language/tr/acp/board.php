...
$lang = array_merge($lang, array(
	...
	'ALLOW_BOARD_NOTIFICATIONS' => 'Mesaj panosu bildirimlerine izin ver',	
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_REMOTE_EXPLAIN'			=> 'Başka bir web sitesinden bağlantı verilen avatarlar.<br><em><strong class="error">Uyarı:</strong> Bu özelliği etkinleştirmek, yalnızca yerel ağ üzerinden erişilebilen dosya ve hizmetlerin varlığını kullanıcıların kontrol etmesine izin verebilir.</em>',
	'ALLOW_REMOTE_UPLOAD'			=> 'Uzak avatar yüklemeyi aç',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Avatarların başka bir web sitesinden yüklenmesine izin ver.<br><em><strong class="error">Uyarı:</strong> Bu özelliği etkinleştirmek, yalnızca yerel ağ üzerinden erişilebilen dosya ve hizmetlerin varlığını kullanıcıların kontrol etmesine izin verebilir.</em>',	
...
$lang = array_merge($lang, array(
	...
	'MAX_POST_IMG_HEIGHT'			=> 'Her mesajdaki en fazla flash yüksekliği',
	'MAX_POST_IMG_HEIGHT_EXPLAIN'	=> 'Mesajlardaki flash dosyalarının en fazla yüksekliği. Sınırsız boyut için 0 olarak ayarların.',
	'MAX_POST_IMG_WIDTH'			=> 'Her mesajdaki en fazla flash genişliği',
	'MAX_POST_IMG_WIDTH_EXPLAIN'	=> 'Mesajlardaki flash dosyalarının en fazla genişliği. Sınırsız boyut için 0 olarak ayarların.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'		=> 'Bunların içerikleri <strong>özet akışlarında gösterilmeyecektir</strong>. Tüm forumlardan veri çekmek için hiç bir forum seçmeyin.<br>Birden çok forumu Seçmek/Seçimi Kaldırmak için <samp>CTRL</samp> tuşuna basılı tutun ve tıklayın.',
));
...
$lang = array_merge($lang, array(
	...
	'COOKIE_PATH_EXPLAIN'		=> 'Site alan adı genelinde çerez erişebilirliği sağlamak için, bu ayar genellikle komut dosyası (script) yolunuzla aynı ya da basit bir eğik çizgi (slaş işareti) olmalıdır.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_NO_IDENTITY'				=> '%s için bir giriş kimliği bulunamadı.',
 	...
 	'LDAP_PASSWORD_EXPLAIN'			=> 'Anonim bağlayıcı kullanılıyorsa boş bırakın, aksi takdirde yukarıdaki kullanıcı için şifre belirtin. Aktif Dizin Sunucuları için gereklidir. <br><em><strong>Dikkat:</strong> Bu şifre düz metin halinde veritabanına kaydedileceği için veritabanınıza erişebilen ya da bu ayar sayfasını görüntüleyebilen herkese görünecektir.</em>',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_EMAIL'					=> 'Kimden e-posta adresi',
	'ADMIN_EMAIL_EXPLAIN'			=> 'Bu, teknik iletişim adresi şeklinde tüm e-postalarda kimden adresi olarak kullanılacaktır. Bu adres, e-postalarda her zaman <samp>Gönderici</samp> adresi olarak kullanılacaktır.',
	...
	'EMAIL_FORCE_SENDER'			=> 'Kimden e-posta adresini zorla',
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'Bu, sunucunun yerel kullanıcısı ve ana bilgisayar adını kullanmak yerine kimden e-posta adresini <samp>Dönüş-Yolu</samp> olarak ayarlar. Bu ayar SMTP kullanılırken geçerli değildir.<br><em><strong>Dikkat:</strong> Sendmail yapılandırmasına güvenilir kullanıcı olarak eklenmesi için web sunucusunda çalışan kullanıcı gereklidir.</em>',
	...
	'EMAIL_MAX_CHUNK_SIZE'			=> 'İzin verilen en fazla e-posta alıcısı',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'Eğer bu ayarı yapmanız gerekiyorsa, e-posta sunucunuzun bir e-posta mesajında izin verdiği en fazla alıcı sayısını aşmayacak şekilde ayarlayın.',	
	...
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Kendinden-imzalı SSL sertifikası ile SMTP sunucusuna bağlantılara izin verir. <br><em><strong>Uyarı:</strong> Kendinden-imzalı SSL sertifikalarına izin vermek güvenlik etkilerine neden olabilir.</em>',
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'Eğer SMTP sunucunuz istiyorsa sadece bir şifre girin. <br><em><strong>Uyarı:</strong> Bu şifre düz metin olarak veritabanında saklanır, veritabanınıza erişebilen veya bu yapılandırma sayfasını görüntüleyebilen herkese görünür.</em>',
	'SMTP_PLAIN'					=> 'PLAIN',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Posta sunucunuz aksini söylemedikçe bir protokol (<samp>ssl://</samp> ya da <samp>tls://</samp>) belirtmeyin.',
	...
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'SMTP sunucusu tarafından kullanılan SSL sertifikasının doğrulamasını istenir. <br><em><strong>Dikkat:</strong> Doğrulanmamış SSL sertifikaları ile yapılan eş bağlantılar güvenlik ile ilgili sonuçlara neden olabilir.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'SMTP eş adını doğrula',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'SSL / TLS bağlantıları kullanılan SMTP sunucuları için eş adlarının doğrulanması istenir. <br><em><strong>Dikkat:</strong> Doğrulanmayan eşlere bağlanmak güvenlik ile ilgili sonuçlara neden olabilir.</em>',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Kendinden-imzalı SSL sertifikası ile Jabber sunucusuna bağlanmaya izin verir. <br><em><strong>Dikkat:</strong> Kendinden-imzalı SSL sertifilarına izin vermek güvenlik ile ilgili sonuçlara neden olabilir.</em>',	
	...
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Jabber sunucusu tarafından kullanılan SSL sertifikasının doğrulamasını istenir. <br><em><strong>Dikkat:</strong> Doğrulanmamış SSL sertifikaları ile yapılan eş bağlantılar güvenlik ile ilgili sonuçlara neden olabilir.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Jabber eş adını doğrula',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'SSL / TLS bağlantıları kullanılan Jabber sunucuları için eş adlarının doğrulanması istenir. <br><em><strong>Dikkat:</strong> Doğrulanmayan eşlere bağlanmak güvenlik ile ilgili sonuçlara neden olabilir.</em>',	
));
